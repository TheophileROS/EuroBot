...
#ifndef __DEBICT_EUROBOT_HARDWARE__EUROBOT_HARDWARE_H__
#define __DEBICT_EUROBOT_HARDWARE__EUROBOT_HARDWARE_H__
...
#include "include_hardware/hardware_compiler.h"
...
namespace debict
{
    namespace eurobot
    {
        namespace hardware
        {
            ...
            class EurobotHardware
                : public hardware_interface::SystemInterface
            {
            public:
                RCLCPP_SHARED_PTR_DEFINITIONS(EurobotHardware)

                DEBICT_EUROBOT_HARDWARE_PUBLIC
            ...
            private:
                ...
                std::shared_ptr<EurobotSerialPort> serial_port_;
...
#endif // __DEBICT_EUROBOT_HARDWARE__EUROBOT_HARDWARE_H__